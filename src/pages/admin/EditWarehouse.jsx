...
import { maharashtraDistricts } from '../../data/warehouses'

const EditWarehouse = () => {
  const { warehouseId } = useParams()
  const navigate = useNavigate()
  const { warehouses, updateWarehouse, deleteWarehouse } = useData()
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">{warehouse.id} • {warehouse.name}</p>
          </div>
        </div>
        <button
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Delete Warehouse?</h3>
            <p className="text-gray-600 mb-4">
              Are you sure you want to delete <strong>{warehouse.name}</strong> ({warehouse.id})? 
      ...
      {showSuccess && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-green-800">Warehouse updated successfully!</p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Warehouse ID cannot be changed</p>
              </div>
